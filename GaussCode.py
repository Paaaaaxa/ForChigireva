...
# XVectorExactly = np.zeros((N,1), dtype=float)
...
for i in range(N):
    ...
    print("Прямой ход шаг номер: ", i+1)
    print("Матрица А")
    print(MatrixA)  # печать на каждом шаге
    print("Матрица В")
    print(MatrixB)
# обратный ход
print("Прямой ход завершен")
...
for i in reversed(range(N)):
    ...
    print("Обратный ход шаг номер: ", N - i)
    print("Матрица А")
    print(MatrixA)  # печать на каждом шаге
    print("Матрица В")
    print(MatrixB)
print("Обратный ход завершен, решение системы найдено.")
